...
#include "vigine/api/reactivestream/abstractreactivestream.h"
 ...
 *
 * @ref ReactiveStream is Level-5 of the five-layer wrapper recipe.
 ...
 */
class ReactiveStream final : public AbstractReactiveStream
{
  public:
    /**
     ...
     */
    ReactiveStream(vigine::messaging::IMessageBus    &bus,
                   vigine::core::threading::IThreadManager &threadManager);

    ~ReactiveStream() override;
    ...
    ReactiveStream(const ReactiveStream &)            = delete;
    ReactiveStream &operator=(const ReactiveStream &) = delete;
    ReactiveStream(ReactiveStream &&)                 = delete;
    ReactiveStream &operator=(ReactiveStream &&)      = delete;
