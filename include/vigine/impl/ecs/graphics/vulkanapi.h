...
/**
 * @brief Vulkan-backed IGraphicsBackend.
 *
 * Owns the Vulkan instance, physical and logical devices, surface,
 * swapchain, and frame renderer. Implements the IGraphicsBackend
 ...
 * path.
 */
class VulkanAPI : public IGraphicsBackend
{
  public:
    VulkanAPI();
    ~VulkanAPI();
