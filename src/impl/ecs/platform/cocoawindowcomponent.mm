...
@interface VigineWindowDelegate : NSObject <NSWindowDelegate> {
  vigine::ecs::platform::CocoaWindowComponent *_component;
}
- (instancetype)initWithComponent:
    (vigine::ecs::platform::CocoaWindowComponent *)component;
@end
...
struct vigine::ecs::platform::CocoaWindowComponent::Impl {
  NSWindow *window = nil;
...
vigine::ecs::platform::CocoaWindowComponent::CocoaWindowComponent()
...
void *vigine::ecs::platform::CocoaWindowComponent::nativeHandle() const {
...
bool vigine::ecs::platform::CocoaWindowComponent::ensureWindowCreated() {
...
void vigine::ecs::platform::CocoaWindowComponent::handleWindowClose() {
  _impl->shouldClose = true;
  if (_eventHandler)
    _eventHandler->onWindowClosed();
}

void vigine::ecs::platform::CocoaWindowComponent::handleWindowResize(int width,
                                                                int height) {
  if (_eventHandler)
...
void vigine::ecs::platform::CocoaWindowComponent::runFrame() {
  runFrameCallback();
...
void vigine::ecs::platform::CocoaWindowComponent::show() {
  @autoreleasepool {
        ...
        if (event) {
          ...
          if (_eventHandler) {
            if (type == NSEventTypeKeyDown || type == NSEventTypeKeyUp) {
              vigine::ecs::platform::KeyEvent keyEvent{};
              ...
              if (type == NSEventTypeKeyDown && event.characters.length > 0) {
                ...
                if (cp >= 0x20 && cp != 0x7F) {
                  vigine::ecs::platform::TextEvent textEvent{};
              ...
              _eventHandler->onMouseButtonDown(
                  vigine::ecs::platform::MouseButton::Left, static_cast<int>(loc.x),
                  static_cast<int>(contentBounds.size.height - loc.y));
              ...
              const NSPoint loc = event.locationInWindow;
              _eventHandler->onMouseButtonDown(
                  vigine::ecs::platform::MouseButton::Right, static_cast<int>(loc.x),
                  static_cast<int>(contentBounds.size.height - loc.y));
