...
vigine::Result EventScheduler::shutdown()
{
    bool expected = false;
...
void EventScheduler::onTimerFired(std::uint64_t timerId)
{
...
void EventScheduler::onOsSignal(OsSignal signal)
{
